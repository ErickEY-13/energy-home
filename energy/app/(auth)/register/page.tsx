        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-md">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Crea tu cuenta y comienza a monitorear tu consumo de energía de forma inteligente.
            </p>
          ...
          <p className="text-gray-600 text-sm">
            © 2025 Energy Home. Todos los derechos reservados.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-gray-900 text-white font-semibold rounded-xl hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 group mt-6"
            >
              {isLoading ? (
