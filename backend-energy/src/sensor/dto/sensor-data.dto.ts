...
export class SensorDataDto {
  @ApiProperty({
    description: 'Serial único del dispositivo ESP32',
  ...
  @ApiProperty({
    description: 'API Key del dispositivo para autenticación',
    example: 'uuid-api-key-generada',
  })
  ...
  @ApiProperty({
    description: 'Amperaje/Corriente medida en Amperes',
    example: 2.5,
  })
